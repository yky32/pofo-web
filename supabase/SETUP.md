...
8c. Paste `supabase/features-raw-pipeline.sql` → **Run** (RAW/preview keys + final locks selections)
8d. Paste `supabase/features-project-memory.sql` → **Run** (event date + location for Memories)
