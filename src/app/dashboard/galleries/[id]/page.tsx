  ...
  return (
    <div className="space-y-6">
      ...
      <section className="relative overflow-hidden rounded-[8px] film-grain">
        <div className="relative aspect-[21/9] min-h-[160px] max-h-[280px] bg-stone-200">
          {cover ? (
            <PhotoImage
              src={cover}
              alt={gallery.title}
      ...
      <div
        className={cn(
          "grid gap-6",
          hasPhotos && !isDemo
            ? "lg:grid-cols-[minmax(0,1fr)_minmax(240px,280px)] lg:items-start"
            : ""
        )}
      >
        <div className="min-w-0 space-y-5">
          {!isDemo && hasPhotos ? (
            <div className="rounded-[8px] border border-stone-200/80 bg-white/60 px-3 py-2.5 backdrop-blur-sm">
        ...
        {/* Share: fixed-width sidebar, never equal-height with tall empty cards */}
        {hasPhotos && !isDemo ? (
